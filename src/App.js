...
function App() {
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition((position) => {
      ...
      console.log("API Key : "+process.env.REACT_APP_MY_API_KEY_OPEN_WEATHER_MAP)
    });
  }, []);
  ...
  const [error, seterror] = useState("This is Example of error");
  ...
  return (
    <section className=" bg-cover h-full w-full bg-[url('https://images.pexels.com/photos/997494/pexels-photo-997494.jpeg')]">
      <div className=" w-[69%]">
        <div className="max-w-screen-xl mx-auto lg:pt-5 lg:px-5 w-full">
          {/* Start coding here */}
          <div className="text-white font-sans  p-1 bg-[#00000050] backdrop-blur-lg rounded-[10px] ">
            <div className="flex items-center justify-between p-4 md:flex-row md:space-y-0 md:space-x-4">
              <div className="w-1/5">
                <a href="/">
                  <img width={120} src={WeatherStatsLogo} alt="" />
                </a>
              </div>
              ...
              <div className="w-3/5">
                ...
                <div className="pt-1 absolute text-red-600  text-sm font-semibold">
                  {error}
                </div>
              </div>
              ...
              {/* <button
                  onClick={getLocation}
                  type="button"
                  className="flex  items-center justify-center px-4 py-2 text-sm font-medium text-black rounded-lg bg-[#ffffff] hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
                >
                  Get My location{" "}
                </button> */}
              <div className="w-1/5">
                <button
                  ...
                  // onClick={FetchMyWeather}
                  type="button"
                  //hover:bg-[#F58733] bg-[#128DBB]
                  className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-80  duration-300 rounded-lg w-full py-[10px] hover:bg-[#F58733] bg-[#128DBB]"
                >
                  Find the Weather
                </button>
              </div>
        ...
        <div className="max-w-screen-xl px-4 mx-auto lg:pt-5 lg:px-5 pb-5 w-full">
          {/* Start coding here */}
          <div className="text-white font-sans  pt-5 pb-14 px-10 bg-[#00000050] backdrop-blur-lg rounded-[10px] ">
            <div className=" items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
              ...
              <div className="text-[25px]  flex justify-between mt-4 bg-black rounded-[10px]  shadow-md  bg-opacity-[0.3] px-10 py-5">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="font-semibold mt-1 text-sm">Visibility</span>
                </div>
